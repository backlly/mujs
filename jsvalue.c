...
void js_newuserdatax(js_State *J, const char *tag, void *data, js_HasProperty has, js_Put put, js_Delete deleteFun, js_Finalize finalize)
{
	js_Object *prototype = NULL;
	js_Object *obj;
	...
	obj->u.user.has = has;
	obj->u.user.put = put;
	obj->u.user.deleteFun = deleteFun;
